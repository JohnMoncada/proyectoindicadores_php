				...
				<table class="table table-striped table-hover">
					...
					<tbody>
						...
						<tr>
							...
							<td><?php echo $arregloUsuario[$i]->getEmail();?> </td>
							<td><?php echo $arregloUsuario[$i]->getContrasena();?></td>
							<td>
								<a href="#editEmployeeModal" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
								<a href="#crudModal" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Eliminar">&#xE872;</i></a>
							</td>
						</tr>
						<?php } ?>
